function bilgisayarOlustur() {
    ...
    //label span gibi seyler yazacagımız zaman kullanırız innertext: eger set etmek istedigin string icerisinde html yoksa kullanılır
}
...
class Bilgisayar {
    ...
    getir() {
        return '<b><i>Marka:</i></b> ' + this.marka + '<br />' +
            ...
            '<b><i>Üretim Tarihi:</i></b> ' + this.uretimTarihi.toLocaleString('tr-TR'); //en-US
